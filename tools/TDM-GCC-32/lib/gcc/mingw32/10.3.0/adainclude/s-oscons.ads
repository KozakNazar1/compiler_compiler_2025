...
package System.OS_Constants is
   ...
   EAGAIN                        : constant := -1;          --  Try again
   ENOENT                        : constant := -1;          --  File not found
   ENOMEM                        : constant := -1;          --  Out of memory
   ...
   ERANGE                        : constant := -1;          --  Result too large
   ...
   E2BIG                         : constant := -1;          --  Argument list too long
   EILSEQ                        : constant := -1;          --  Illegal byte sequence
   ...
   IPPROTO_EGP                   : constant := -1;          --  Exterior Gateway Protocol
   ...
   IPPROTO_PIM                   : constant := -1;          --  Protocol Independent Multicast
   IPPROTO_COMP                  : constant := -1;          --  Compression Header Protocol
   IPPROTO_SCTP                  : constant := -1;          --  Stream Control Transmission Protocol
