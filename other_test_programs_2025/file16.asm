...
neg_and_done:
    ...
    dec dword ptr [ebx]
    push ebx
    LABEL@AFTER_TO_00007FF63378E958:
    ...
    jge LABEL@EXIT_FOR_00007FF63378D068
    inc dword ptr [ebx]
    ...
    ;"}" (after "FOR")
    jmp LABEL@AFTER_TO_00007FF63378E958
    LABEL@EXIT_FOR_00007FF63378D068:
    add esp, 4; add esp, 8
    ...
    dec dword ptr [ebx]
    push ebx
    LABEL@AFTER_TO_00007FF6337976A8:
    ...
    mov ebx, dword ptr [esp]
    cmp dword ptr [ebx], eax
    jge LABEL@EXIT_FOR_00007FF633795DB8
    inc dword ptr [ebx]
    ...
    ;"NULL" (after "FOR")
    jmp LABEL@AFTER_TO_00007FF6337976A8
    LABEL@EXIT_FOR_00007FF633795DB8:
    add esp, 4; add esp, 8
    ...
    dec dword ptr [ebx]
    push ebx
    LABEL@AFTER_TO_00007FF6337A03F8:
    ...
    mov ebx, dword ptr [esp]
    cmp dword ptr [ebx], eax
    jge LABEL@EXIT_FOR_00007FF63379EB08
    inc dword ptr [ebx]
    ...
    ;"NULL" (after "FOR")
    jmp LABEL@AFTER_TO_00007FF6337A03F8
    LABEL@EXIT_FOR_00007FF63379EB08:
    add esp, 4; add esp, 8
