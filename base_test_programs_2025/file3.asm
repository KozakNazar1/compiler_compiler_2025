...
neg_and_done:
    ...
    dec dword ptr [ebx]
    push ebx
    LABEL@AFTER_TO_00007FF63378BBA0:
    ...
    jge LABEL@EXIT_FOR_00007FF63378A2B0
    inc dword ptr [ebx]
    ...
    ;"NULL" (after "FOR")
    jmp LABEL@AFTER_TO_00007FF63378BBA0
    LABEL@EXIT_FOR_00007FF63378A2B0:
    add esp, 4; add esp, 8
    ...
    dec dword ptr [ebx]
    push ebx
    LABEL@AFTER_TO_00007FF633791710:
    ...
    mov ebx, dword ptr [esp]
    cmp dword ptr [ebx], eax
    jge LABEL@EXIT_FOR_00007FF63378FE20
    inc dword ptr [ebx]
    ...
    dec dword ptr [ebx]
    push ebx
    LABEL@AFTER_TO_00007FF6337944C8:
    ...
    mov ebx, dword ptr [esp]
    cmp dword ptr [ebx], eax
    jge LABEL@EXIT_FOR_00007FF633792BD8
    inc dword ptr [ebx]
    ...
    ;"NULL" (after "FOR")
    jmp LABEL@AFTER_TO_00007FF6337944C8
    LABEL@EXIT_FOR_00007FF633792BD8:
    add esp, 4; add esp, 8

    ;"NULL" (after "FOR")
    jmp LABEL@AFTER_TO_00007FF633791710
    LABEL@EXIT_FOR_00007FF63378FE20:
    add esp, 4; add esp, 8
