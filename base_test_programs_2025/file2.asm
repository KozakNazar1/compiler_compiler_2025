...
neg_and_done:
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF63378D490
    ...
    mov eax, 1
    LABEL@AFTER_THEN_00007FF63378D490:

    ;"ELSE" (part of "ELSEIF")
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF63378F1A8
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF633791F60
    ...
    mov eax, 1
    LABEL@AFTER_ELSE_00007FF63378F1A8:
    LABEL@AFTER_THEN_00007FF633791F60:

    ;"ELSE"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF633793C78
    ...
    ;";" (after "ELSE")
    LABEL@AFTER_ELSE_00007FF633793C78:
    ...
    ;after cond expresion (after "IF")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF63379A888
    ...
    ;";" (after "then"-part of IF-operator)
    mov eax, 1
    LABEL@AFTER_THEN_00007FF63379A888:

    ;"ELSE"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF63379C178
    ...
    ;";" (after "ELSE")
    LABEL@AFTER_ELSE_00007FF63379C178:
    ...
    ;after cond expresion (after "IF")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF6337A2538
    ...
    ;";" (after "then"-part of IF-operator)
    mov eax, 1
    LABEL@AFTER_THEN_00007FF6337A2538:

    ;"ELSE"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF6337A3E28
    ...
    ;";" (after "ELSE")
    LABEL@AFTER_ELSE_00007FF6337A3E28:
    ...
    ;after cond expresion (after "IF")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF6337A7C80
    ...
    ;";" (after "then"-part of IF-operator)
    mov eax, 1
    LABEL@AFTER_THEN_00007FF6337A7C80:

    ;"ELSE"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF6337A9570
    ...
    ;";" (after "ELSE")
    LABEL@AFTER_ELSE_00007FF6337A9570:
